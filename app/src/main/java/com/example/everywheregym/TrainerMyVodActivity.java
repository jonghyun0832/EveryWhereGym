...
public class TrainerMyVodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainer_my_vod);

        iv_back = (ImageView) findViewById(R.id.iv_my_vod_back);

        recyclerView = (RecyclerView) findViewById(R.id.rv_my_vod);
        ...
        vodUploaderAdapter.setOnMoreClickListener(new VodUploaderAdapter.vodUploaderAdapterMoreClickListener() {
            ...
            public void whenMoreClick(int position) {
                ...
                AlertDialog.Builder ad = new AlertDialog.Builder(TrainerMyVodActivity.this);
                LayoutInflater inflater = (LayoutInflater) TrainerMyVodActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    ...
                    public void onResponse(Call<VodData> call, Response<VodData> response) {
                        if (response.isSuccessful() && response.body() != null){
                            if(response.body().isSuccess()){
                                ...
                                iv_more_register.setImageDrawable(ContextCompat.getDrawable(TrainerMyVodActivity.this,R.drawable.ic_baseline_cancel_24));
...
//                }
                ...
                WindowManager windowManager = (WindowManager) TrainerMyVodActivity.this.getSystemService(Context.WINDOW_SERVICE);
                ...
                tv_more_edit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        alertDialog.dismiss();
                        Intent intent = new Intent(TrainerMyVodActivity.this, VodDetailActivity.class);
                        intent.putExtra("vod_id",vod_id);
                ...
                tv_more_delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        alertDialog.dismiss();
                        AlertDialog.Builder ad2 = new AlertDialog.Builder(TrainerMyVodActivity.this);
                        ad2.setTitle("알림");
                        ...
                        ad2.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                call.enqueue(new Callback<VodData>() {
                                    ...
                                    public void onResponse(Call<VodData> call, Response<VodData> response) {
                                        if (response.isSuccessful() && response.body() != null){
                                            if(response.body().isSuccess()){
                                                ...
                                                Toast.makeText(TrainerMyVodActivity.this, "삭제가 완료되었습니다.", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    }
                                    ...
                                    @Override
                                    public void onFailure(Call<VodData> call, Throwable t) {
                                        Toast.makeText(TrainerMyVodActivity.this, "삭제 통신 문제.", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                ...
                                public void onResponse(Call<VodData> call, Response<VodData> response) {
                                    if (response.isSuccessful() && response.body() != null){
                                        if(response.body().isSuccess()){
                                            ...
                                            Toast.makeText(TrainerMyVodActivity.this, "서버에서 삭제실패", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
    ...
    protected void onResume() {
        ...
        ApiInterface apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<VodDataArray> call = apiInterface.getTrainervodList(user_id);
        call.enqueue(new Callback<VodDataArray>() {
            ...
            public void onFailure(Call<VodDataArray> call, Throwable t) {
                Toast.makeText(TrainerMyVodActivity.this, "통신 오류", Toast.LENGTH_SHORT).show();
            }
        });
